...
//    mProgressView = findViewById(R.id.login_progress);
  ...
  public void attemptLogin() {
    ...
    if (TextUtils.isEmpty(email)) {
      textViewUserName.setError(getString(R.string.error_field_required));
      focusView = textViewUserName;
      cancel = true;
    }
    else if (!isEmailValid(email)) {
      textViewUserName.setError(getString(R.string.error_invalid_email));
      focusView = textViewUserName;
      cancel = true;
    }
...
//    textViewUserName.setAdapter(adapter);
  }
  ...
  public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
    ...
    protected void onPostExecute(final Boolean success) {
      ...
      if (success) {
        ...
        textViewPassword.setError(getString(R.string.error_incorrect_password));
